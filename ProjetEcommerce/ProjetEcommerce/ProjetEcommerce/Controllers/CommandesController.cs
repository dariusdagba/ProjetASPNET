...
namespace ProjetEcommerce.Controllers
{
    public class CommandesController : Controller
    {
        ...
        public CommandesController(ProjetEcommerceContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CommandeId,DateCommande")] Commande commande)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CommandeId,DateCommande")] Commande commande)
        {
